...
public interface BlueprintsPersistence {
     ...
     * @throws
     */
    void modifyOrAddBlueprintS(Blueprint bp, String author, String name) throws BlueprintPersistenceException;
     ...
     * @throws BlueprintNotFoundException if there is no such blueprint
     */
    Set<Blueprint> getAllBluePrint() throws BlueprintNotFoundException;

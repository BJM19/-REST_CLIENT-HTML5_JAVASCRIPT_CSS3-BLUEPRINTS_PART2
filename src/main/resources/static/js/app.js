const app = (function () {
    ...
    function saveBlueprint() {
        let bluep = $("#newbp").val();
        blueprintName = bluep;
        let puntos = apievent.getPuntos();
        const promise = $.post({
            url: "/blueprints",
            contentType: "application/json",
            data: "{\"author\": \"" + author + "\",\"points\":" + JSON.stringify(puntos) + ",\"name\":" + "\"" + bluep + "\"" + "}",
        });
    ...
    function updateBlueprint() {
        ...
        return $.ajax({
            ...
            type: 'PUT',
            data: "{\"author\": \"" + author + "\",\"points\":" + JSON.stringify(puntos) + ",\"name\":" + "\"" + blueprintName + "\"" + "}",
            contentType: "application/json",
    ...
    return {
        ...
        saveUpdateParcero: saveUpdateParcero,
